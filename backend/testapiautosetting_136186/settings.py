"""
Django settings for testapiautosetting_136186 project.
...
ROOT_URLCONF = 'testapiautosetting_136186.urls'
...
WSGI_APPLICATION = 'testapiautosetting_136186.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "TestAPIAutoSettingsq9l3n Support <support@testapiautosetting-136186.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapiautosetting_136186 API",
    "DESCRIPTION": "API documentation for testapiautosetting_136186 App",
    "VERSION": "v1",
}
